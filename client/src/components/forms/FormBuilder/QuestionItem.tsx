                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            >
                                ...
                                <div className="pointer-events-none text-muted-foreground">▼</div>
                            </button>
                                ...
                                <div className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md border bg-popover text-popover-foreground shadow-md ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <div className="p-1">
                                        {questionTypes.map((type) => (
                                            <div
                                                key={type.value}
                                                className={`relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-2 pr-2 text-sm outline-none hover:bg-accent hover:text-accent-foreground ${type.value === q.type ? "bg-accent" : ""}`}
                                                onClick={() => {
                                                    updateQuestion(q.id, {
                                                        type: type.value,
                                                        options: [],
